...
export default function CleaningGeorgia() {
  ...
  return (
    <main className="bg-slate-50">
      ...
      <section className="relative isolate overflow-hidden bg-slate-900">
        ...
        <Container>
          <div className="py-12 lg:py-20 grid items-center gap-8 lg:grid-cols-2">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-green-400">Georgia • Atlanta Metro</p>
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Silo Cleaning in Atlanta, GA</h1>
              <p className="mt-3 max-w-2xl text-slate-200">
                Professional Georgia silo cleaning by confined-space trained technicians. We serve facilities across Atlanta and statewide with high-volume grain vacuums, bin whips, targeted blasting, and sanitation to restore safety and flow.
              </p>
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  href="tel:+14048970042"
                ...
                >
                  <Phone className="h-4 w-4" /> Call (404) 897-0042
                </a>
                <a
                  href="/quote"
            ...
            <figure className="relative mx-auto w-full max-w-lg overflow-hidden rounded-2xl border border-white/10">
              <img
                src="/silo_img_2.jpg"
                alt="Georgia silo cleaning technicians at work"
      ...
      <Section
        kicker="What we do in Georgia"
        title="Georgia Silo Cleaning Services"
      ...
      <Section className="pt-0">
        <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border bg-white p-6 shadow-sm sm:flex-row">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Request a Georgia quote</h3>
            <p className="text-slate-600">Call us at (404) 897-0042 for Atlanta and statewide service.</p>
          </div>
      ...
      {/* Process snapshot */}
      <Section kicker="How we work" title="Safe, efficient confined-space cleaning" subtitle="Built for food, feed, plastics, and cement facilities in Georgia." className="pt-0">
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-2xl shadow-lg">
            <img
              src="/silo_img_2.jpg"
              alt="Atlanta, GA silo cleaning operations"
      ...
      {/* Proof / badges */}
      <Section kicker="Why us" title="Georgia-ready: safety, speed, reliability">
      ...
      <Section
        kicker="FAQ"
        title="Georgia silo cleaning questions"
      ...
      >
        <div className="mr-auto space-y-4">
          {[
            {
              q: "Do you service Atlanta and surrounding areas?",
              a: "Yes. We service Atlanta metro and facilities across Georgia, with rapid mobilization for emergency needs.",
            },
            {
      ...
      <Section className="pt-0">
        <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border bg-white p-6 shadow-sm sm:flex-row">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Serving Atlanta and all of Georgia</h3>

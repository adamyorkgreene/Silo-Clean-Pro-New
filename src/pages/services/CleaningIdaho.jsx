...
export default function CleaningIdaho() {
  return (
    <main className="bg-slate-50">
      ...
      <section className="relative isolate overflow-hidden bg-slate-900">
        ...
        <Container>
          <div className="py-12 lg:py-20 grid items-center gap-8 lg:grid-cols-2">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-green-400">Idaho • Boise Metro</p>
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Idaho Silo Cleaning Services</h1>
              <p className="mt-3 max-w-2xl text-slate-200">
                We are a dependable, certified, and highly-trained silo cleaning company serving clients across Idaho. Based around Boise and mobilizing statewide, we use high-volume vacuums, bin whips, targeted blasting, and sanitation to restore safety and flow.
              </p>
            ...
            <figure className="relative mx-auto w-full max-w-lg overflow-hidden rounded-2xl border border-white/10">
              <img
                src="/silo_img_2.jpg"
                alt="Idaho silo cleaning technicians at work"
      ...
      <Section
        kicker="What we do in Idaho"
        title="Our Idaho Silo Cleaning Services"
      ...
      {/* Process snapshot */}
      <Section kicker="How we work" title="Safe, efficient confined-space cleaning" subtitle="Built for food, feed, plastics, and cement facilities in Idaho." className="pt-0">
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-2xl shadow-lg">
            <img
              src="/silo_img_2.jpg"
              alt="Silo cleaning operations in Idaho"
      ...
      {/* Proof / badges */}
      <Section kicker="Why us" title="Idaho-ready: safety, speed, reliability">
      ...
      <Section
        kicker="FAQ"
        title="Idaho silo cleaning questions"
      ...
      >
        <div className="mr-auto space-y-4">
          {[
            {
              q: "Do you service Boise and surrounding areas?",
              a: "Yes. We service Boise metro and facilities across Idaho, with rapid mobilization for emergency needs.",
            },
            {
      ...
      <Section className="pt-0">
        <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border bg-white p-6 shadow-sm sm:flex-row">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Serving Boise and all of Idaho</h3>
